...
/**
 * Request payload for document processing API.
 */
public class DocumentProcessingRequest {
    ...
    public DocumentProcessingRequest(String gcsUrl) {
        this.gcsUrl = gcsUrl;
    }

    public DocumentProcessingRequest(String gcsUrl, String mimeType, String documentType, String customPrompt) {
        this.gcsUrl = gcsUrl;
